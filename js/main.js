...
var Dog = function(object) {
  var object = object || {};
  this.hungry = (object.hungry !== undefined ? object.hungry : true);
  this.status = (object.pet !== undefined ? object.staus : 'normal');
  this.color = (object.color !== undefined ? object.color : 'black');
};

var Human = function(object) {
  var object = object || {};
  ...
  this.cool = (object.cool !== undefined ? object.cool : false);
